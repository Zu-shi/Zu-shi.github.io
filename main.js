...
looking_glass.src = 'Assets\\EEE_Looking_Glass.webp';
...
function RedrawBackground(c)
{
	...
	startx = startxy.x + font_start;
	starty = startxy.y + font_start;

	ctx.globalAlpha = 0.7;
	for (let i in Events) {
		ctx.font = "lighter 20px Times New Roman";
		ctx.fillStyle = "#eeeeee";
		ctx.fillText(Events[i]["Name"], startx, starty);
		starty += (font_size + font_gap);
	}
	ctx.globalAlpha = 1;
}
